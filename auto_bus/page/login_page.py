...
class LoginPage:
    ...
    def get_username_element(self):
        return self.locator.get_element("login_element","username")

    # get password text field
    def get_password_element(self):
        return self.locator.get_element("login_element","password")

    # get log in button
    def get_login_button(self):
        return self.locator.get_element("login_element","login")

    # get login as guest button
    def get_login_as_guest(self):
        return self.locator.get_element("login_element","login_guest")
